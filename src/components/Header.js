      ...
      <div className="about">
        ...
        <Fade right cascade duration={2000} delay={2000}>
          <section>
            ...
            <p>
              My focus so far has been front-end development in React. Currently, I have started building projects in Node.js/Express/mongoDB with the goal of building with the MERN stack. That said, I am constantly learning and improving and am fully willing and able to dive head first into any tech-stack. 
            </p>
            <p>
